...
document.getElementById('verificationName').addEventListener('submit', function(e) {
    ...
    // Validasi nama
    const validNames = ['160123', 'Jogja8686', '16 januari 2023', '16januari2023', '16 jan 2023', '16-01-2023', '16 jan 23'];
...
document.getElementById('verification').addEventListener('submit', function(e) {
    ...
    if (isPartner !== 'yes') {
        Swal.fire({
            title: 'Bukan pacar ojan! harus iya.',
...
const animationTimeline = () => {
    ...
    // Restart Animation on click dan buka WhatsApp
const replyBtn = document.getElementById("replay");
...
replyBtn.addEventListener("click", () => {
    ...
    const waLink = "https://wa.me/+6281225487266?text=ay%20aku%20udh%20baca%20%F0%9F%98%9A%E2%9D%A4%EF%B8%8F";
